...
if(isset($_POST['email'])) {
    ...
    $email_to = "kimberleechoo96@gmail.com";
    ...
    function died($error) {
        ...
        echo "<h1>Whoops!</h1><h2>There appears to be something wrong with your form.</h2>";
  ...
  if(!preg_match($email_exp,$email_from)) {
    ...
    $error_message .= '<li><p>The  e-mail address appears to be incorrect<p></li>';
